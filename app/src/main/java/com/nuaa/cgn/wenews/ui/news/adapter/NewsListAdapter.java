...
import com.nuaa.cgn.wenews.utils.TimeUtils;
...
public class NewsListAdapter extends BaseMultiItemQuickAdapter<News, BaseViewHolder> {
    ...
    public NewsListAdapter(List<News> data, String code, Context context) {
        super(data);
        ...
        switch (baseViewHolder.getItemViewType()) {
            ...
            case News.TYPE_CENTER_PIC_NEWS:
                ...
                if (news.has_video) {
                    ...
                    //中间图片使用视频大图
                    //mageLoaderUtil.LoadImage(mContext, news.video_detail_info.detail_video_large_image.url, (ImageView) baseViewHolder.getView(R.id.iv_img));
                } else {
